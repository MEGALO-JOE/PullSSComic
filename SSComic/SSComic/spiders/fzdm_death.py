...
class FzdmSpider(scrapy.Spider):
    ...
    # global base_url
    # base_url = 'https://manhua.fzdm.com/07/{}/index_0.html'
    # hua = [base_url.format(i) for i in range(137, 687)]
    # juan = [base_url.format(f"Vol_0{i}") for i in [f"0{i}" if len(str(i)) == 1 else i for i in range(1, 16)]]
    # start_urls = hua + juan

    start_urls = ['https://manhua.fzdm.com/07/Vol_014/index_0.html']
    ...
    def parse(self, response):
        ...
        item["save_path"] = os.path.join("death", item["title"])
